export default {
  ...
  frontend: {
    ...
    projectGroceryCartDescription: 'Um conceito muito simples de carrinho de compras feito com uma antiga release candidate do Vue 3, para experimentar a nova Composition API.',
    projectParsingHellTitle: 'Parsing Hell',
    projectParsingHellDescription: 'Webpage puramente em HTML e CSS que fiz no início de meu aprendizado em desenvolvimento Web. Também, uma das mais divertidas de fazer.'
  },
  backend: {
    title: 'Backend',
    ...
    conclusion: 'Tenho alguns projetos de Backend publicamente disponíveis, que podem ser conferidos abaixo:',
    ...
    projectMariadbSqlaDockerSetupDescription: 'Um simples setup de banco de dados MariaDB containerizado, usando SQLAlchemy, Alembic e docker-compose.'
  },
  fullstack: {
    title: 'FullStack',
    intro: ' Meus projetos pessoais FullStack ainda não avançaram para fase de publicação, com uma exceção:',
    projectLaboratorioTitle: 'Laborator.io',
    projectLaboratorioDescription: 'Laborator.io é uma aplicação FullStack ainda em desenvolvimento, desenhada para a administração de laboratórios de pesquisa científica. Ela funciona com um servidor Flask comunicando-se com um cliente em Quasar. Esse projeto está pendendo um grande processo de redesign, no intento de melhor modularizá-lo e ajustá-lo às demandas de pesquisadores.'
  }
};
