export default {
  ...
  frontend: {
    title: 'Frontend',
    intro: 'Below are links for a few Frontend projects that I have made and are available:'
  },
  backend: {
    title: 'Backend',
    intro: 'Below are links for a few Backend projects that I have made and are available:'
  },
  fullstack: {
    title: 'FullStack',
    intro: 'Below are links for a few FullStack projects that I have made and are available:'
  }
};
